...
///
///@brief write solution header to output stream\n
///@details 把解算头写进输出流
///
///@param stream 信息流
///@param solopt 解算设置选项
...
///
///@brief write solution to output stream
///@details 把解算结果放到输出流
///
///@param svr 服务器结构体
///@param index 缓冲索引
...
///
///@brief update glonass frequency channel number in raw data struct
///@details 更新服务器结构体内原始数据里的GLONASS频率频道号
///
///@param svr 服务器结构体
///
